...
import com.example.myimageloaderproject.modules.home.data.repository.PhotoRepositoryV2Impl
...
class HomeModule(
    ...
    val photoRepository: PhotoRepositoryV2 by lazy {
        PhotoRepositoryV2Impl(
